    ...
    <footer className="footer p-10 bg-base-300 text-base-content">
      <div>
        ...
        <p>
          Garden Shippuen LLC
          <br />
          Providing reliable groceries since 1992
        </p>
      </div>
      <div>
        <span className="footer-title text-primary">Categories</span>
        <a className="link link-hover">Produce</a>
        <a className="link link-hover">Dairy & Eggs</a>
        <a className="link link-hover">Meat</a>
        <a className="link link-hover">Seafood</a>
        <a className="link link-hover">Frozen Foods</a>
      </div>
      <div>
